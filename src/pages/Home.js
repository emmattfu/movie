              ...
              return (
                <div className="home-poster" key={el.id} id={`id_${i}`}>
                  <Link to={`/shows/details/${el.id}`} >
                    <img src={`https://image.tmdb.org/t/p/original/${el.backdrop_path}`} alt="home-tv-poster"/>
              ...
              return (
                <div className="home-poster" id={`id_${i + 3}`} key={el.id}>
                  <Link to={`/movies/details/${el.id}`}>
                    <img src={`https://image.tmdb.org/t/p/original/${el.backdrop_path}`} alt="home-movie-poster"/>
